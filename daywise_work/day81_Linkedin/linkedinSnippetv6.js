...
// @version      0.1
// @description  Script to filter and remove jobs that either have easy apply option or are promoted jobs.
// @author       ameshalexk
...
(function () {
  ...
  setTimeout(function () {
    ...
    let check = JSON.stringify(amesh);
    GM_xmlhttpRequest({
      method: 'POST',
      url: 'https://floating-journey-96979.herokuapp.com/api',
      headers: {
        'Content-Type': 'application/json',
      },
      data: JSON.stringify({ address: check }),
