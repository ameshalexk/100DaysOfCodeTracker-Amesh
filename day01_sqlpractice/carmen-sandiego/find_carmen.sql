...
select * from country WHERE continent = 'Europe' ORDER BY population ASC LIMIT 1;
...
select * from country WHERE region = 'Southern Europe' AND code = 'SMR' OR code = 'ITA' OR code ='CHE' ORDER BY population ASC LIMIT 5;
...
SELECT *  FROM city WHERE SUBSTR(name, 1,4) = 'Serr';
